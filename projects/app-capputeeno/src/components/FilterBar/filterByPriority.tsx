...
export const FilterByPriority = () => {
  ...
  return (
    <S.FilterByPriorityContainer isOpen={open}>
      ...
      {open ? (
        <S.FilterByPrioritys>
          <S.FilterByPrioritysItem
            slected={priority === FiltePriority.NEWS}
            onClick={() => handleUpdatePriority(FiltePriority.NEWS)}
          >
            Novidades
          </S.FilterByPrioritysItem>
          <S.FilterByPrioritysItem
            slected={priority === FiltePriority.BIGGEST_PRICE}
            onClick={() => handleUpdatePriority(FiltePriority.BIGGEST_PRICE)}
          >
            Preço: maior menor
          </S.FilterByPrioritysItem>
          <S.FilterByPrioritysItem
            slected={priority === FiltePriority.MINOR_PRICE}
            onClick={() => handleUpdatePriority(FiltePriority.MINOR_PRICE)}
          >
            Preço: menor maior
          </S.FilterByPrioritysItem>
          <S.FilterByPrioritysItem
            slected={priority === FiltePriority.POPULARITY}
